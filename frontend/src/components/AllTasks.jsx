...
export default function AllTasks({ tasks, addTask, deleteTask, updateTask }) {
  ...
  return (
    <div className="w-[calc(100%-1rem)] bg-slate-100 dark:bg-gray-900 p-4 md:p-6 rounded-xl shadow-sm border dark:border-gray-800"> 
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-base md:text-lg font-semibold text-slate-800 dark:text-gray-200">All Tasks</h2>
      </div>
      ...
      <div className="space-y-2 max-h-[calc(100vh-250px)] overflow-y-auto scrollbar-thin scrollbar-thumb-slate-300 dark:scrollbar-thumb-gray-700">
